...
export const Canvas = ({
  ...
  const startMultiSelection = useCallback((
    ...
    // Start multiselection if difference is > 5, 5 threshold
    if (
  ...
  const onLayerPointerDown = useMutation((
    ...
    // console.log({ self, setMyPresence });
  ...
  return (
    ...
    >
      ...
      {/* All shapes, drawings go inside here */}
      <svg
      ...
      >
        ...
        >
          {/* view changes from on pointer up */}
